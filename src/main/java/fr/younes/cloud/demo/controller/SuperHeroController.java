package fr.younes.cloud.demo.controller;


import fr.younes.cloud.demo.model.SuperHero;
import fr.younes.cloud.demo.service.SuperHeroService;
...
public class SuperHeroController {
    ...
    @Timed(value = "greeting.time", description = "Time taken to persist superHero")
    @PostMapping
